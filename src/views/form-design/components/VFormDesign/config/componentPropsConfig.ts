...
export const baseComponentControlAttrs: Omit<IBaseFormAttrs, "tag">[] = [
   ...
   },
   {
      name: "allowClear",
      label: "可清除",
      includes: ["Input", "Select", "InputTextArea", "InputNumber", "DatePicker", "RangePicker", "MonthPicker", "TimePicker", "Cascader", "TreeSelect", "AutoComplete"],
   },
...
export const baseComponentCommonAttrs: Omit<IBaseFormAttrs, "tag">[] = [
   ...
   },
   {
      ...
      includes: ["AutoComplete", "InputTextArea", "InputNumber", "Input", "InputTextArea", "Select", "DatePicker", "MonthPicker", "TimePicker", "TreeSelect", "Cascader"],
   },
   {
      name: "style",
      label: "样式",
